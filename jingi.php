...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <link href="login_files/bootstrap-responsive.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container"> 
      <p id = "mine"><font style = "font-family:helvetica; font-size:20px; text-decoration:underline;">About ICSTS:</font><br><br>ICSTS is at aimed at simplifying the student teacher interaction.It is a tool that helps manage in the <em>centralized management</em> of the entire academic curicullum and many other things, start using to know more.</p>
